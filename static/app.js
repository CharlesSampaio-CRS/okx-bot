...
const DOCS_GLOSSARY = [
  ...
  { term: "Alvo ambicioso", aliases: ["alvo amplo", "alvo agressivo", "fibonacci 618", "62% da queda", "alvo alto"], def: "No Caçador: preço de venda mais alto. Mira ~62% da queda 24h. Se isso empatar com o conservador, estica (~1,5× ou ~79% da queda). O ATR não corta abaixo da recuperação. Não dispara ordem." },
